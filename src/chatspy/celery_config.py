    ...
    def get_celery_config(self):
        ...
        config = {
            ...
            "task_routes": {
                ...
                "core.models.send_beneficiary_paid_notification": {"queue": "projectQ"},
                "core.models.send_disbursement_cancelled_notification": {"queue": "projectQ"},
                "core.models.send_disbursement_fully_paid_notification": {"queue": "projectQ"},
                "core.models.send_donor_disbursement_notification": {"queue": "projectQ"},
